...
public class Wuhumc implements ModInitializer {
    ...
    public static ConfigHolder<ServerConfigWrapper> configHolder;
    public static ServerConfig config;

    @Override
    public void onInitialize() {
        AutoConfig.register(ServerConfigWrapper.class, PartitioningSerializer.wrap(GsonConfigSerializer::new));
        configHolder = AutoConfig.getConfigHolder(ServerConfigWrapper.class);
        config = configHolder.getConfig().server;
