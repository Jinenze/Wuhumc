...
public record WSNZSubGame(int delay, int score, ScoringRule scoringRule,
                          ActionList<ServerActionContext> actions) implements ActionProvider<ServerActionContext> {
    @Override
